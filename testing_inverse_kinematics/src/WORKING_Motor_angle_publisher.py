...
def inverse_kinematics(pose: Pose) -> JointState:
    ...
    Px_desired =  pose.position.x # 0.18
    Py_desired =  pose.position.y # 0.02
    ...
    if theta1_abs > 0:
        ...
        if theta1_abs < -np.pi:
            theta1_abs = 1*(2*np.pi + theta1_abs)
    print('theta1new',theta1_abs)
        

    print('theta2old',theta2_relative)
    if theta2_relative > 0:
        ...
        if theta2_relative < -np.pi:
            theta2_relative = 1*(2*np.pi + theta2_relative)
    print('theta2new',theta2_relative)

    print('theta3old',theta3_relative)
    ...
    print('theta3new',theta3_relative)
    ...
    print('thetas before conversion for robot: ',theta1_abs,theta2_relative,theta3_relative)
    print('thetas after conversion for robot: ',-theta1_abs,theta2_relative,-theta3_relative)
