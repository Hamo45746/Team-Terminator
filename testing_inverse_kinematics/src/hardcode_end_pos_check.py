...
def verify(joint_state: JointState): # passes in the desired state
    ...
    global grab_state, colour_state,drop_state, state,been_1q_g,been_1q_i,been_1q_d,pub_close
    print('\n'',state:',(state),'\n')
    if len(joint_state.position) == 4:
        if (state==1):
            ...
            ''' 
            desired_theta1 = colour_state.position[0]
            desired_theta2 = colour_state.position[1]
            desired_theta3 = colour_state.position[2]
            desired_theta4 = colour_state.position[3]
            #'''
            desired_theta1 = 0
            desired_theta2 = 0.72
            desired_theta3 = -1.44
