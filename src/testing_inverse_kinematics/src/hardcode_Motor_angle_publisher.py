...
def inverse_kinematics(pose: Pose) -> JointState:
    global pub_joint,colour,state,pub_grab_state,pub_drop_state,pub_colour_state,pub_wait_state
    print('received')
    L1 = 0.055
    L2 = 0.118
    L3 = 0.094
...
def main():
    global pub_colour_state,pub_joint,pub_drop_state,pub_grab_state,pub_wait_state
    # Create publisher
